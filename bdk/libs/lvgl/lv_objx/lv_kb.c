...
static const char * kb_map_lc[] = {
    ...
    "_", "-", "z", "x", "c", "v", "b", "n", "m", ".", ",", ":", "\n",
    "\202"SYMBOL_CLOSE, "\202"SYMBOL_LEFT, "\202"SYMBOL_UP, "\204 ", "\202"SYMBOL_DOWN, "\202"SYMBOL_RIGHT, "\202"SYMBOL_OK, ""
};
...
static lv_res_t lv_kb_def_action(lv_obj_t * kb, const char * txt)
{
    ...
    else if(strcmp(txt, SYMBOL_UP) == 0) lv_ta_cursor_up(ext->ta);
    else if(strcmp(txt, SYMBOL_DOWN) == 0) lv_ta_cursor_down(ext->ta);
